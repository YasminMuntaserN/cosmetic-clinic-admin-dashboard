        ...
        <PageLayout>
            <div className="p-6 max-w-7xl mx-auto font-slab">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-4 mb-8">
                    ...
                    <div className="flex gap-5">
                        <EditModal dataType={dataType} selectedData={selectedData}
                                   button={<Button variant="BgDashedButton"> <Settings size={16} className="mr-3"/> Edit
                                   </Button>}/>
                        <DeleteModal id={selectedData.id} dataType={dataType}
                                     button={<Button variant="BgDashedButton"> <Trash2 size={16}
